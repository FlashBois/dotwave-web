...
export class VaultsAccount {
	 ...
	 */
	get_borrow_position_info(
		vault_index: number,
		statement: Uint8Array,
		current_time: number
	): BorrowPositionInfo | undefined;
	/**
	 * @param {number} vault_index
	 ...
	 */
	get_lp_position_info(
		vault_index: number,
		strategy_index: number,
		statement: Uint8Array,
		current_time: number
	): LpPositionInfo | undefined;
	/**
	 * @param {number} vault_index
	 * @param {Uint8Array} statement
	 * @param {number} current_time
	 ...
	 */
	get_trading_position_info(
		vault_index: number,
		statement: Uint8Array,
		current_time: number
	): TradingPositionInfo | undefined;
	/**
	 * @param {number} id
	 * @param {bigint} value
	 * @returns {bigint}
