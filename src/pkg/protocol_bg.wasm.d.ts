...
export function __wbg_get_lppositioninfo_max_withdraw_value(a: number): number;
export function __wbg_set_lppositioninfo_max_withdraw_value(a: number, b: number): void;
...
export function statementaccount_permitted_withdraw(a: number, b: number): number;
...
export function __wbg_get_strategyinfo_collateral_ratio(a: number): number;
export function __wbg_set_strategyinfo_collateral_ratio(a: number, b: number): void;
