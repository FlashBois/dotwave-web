...
export function __wbg_get_basekeywithid_base_key(a: number): number;
export function __wbg_set_basekeywithid_base_key(a: number, b: number): void;
export function __wbg_get_basekeywithid_quote_key(a: number): number;
export function __wbg_set_basekeywithid_quote_key(a: number, b: number): void;
